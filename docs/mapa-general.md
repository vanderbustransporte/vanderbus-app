...
`.claude/skills/transallinone-app.md` y en las migraciones.
...
16. **La doc está desincronizada entre sí.** El roadmap de
    `.claude/skills/transallinone-app.md` da las migraciones de despacho y choferes como
...
| Documento | Qué tiene |
|---|---|
| `.claude/skills/transallinone-app.md` | Arquitectura fina, convenciones de código, modelo de datos con columnas. **Obligatorio antes de tocar código** |
